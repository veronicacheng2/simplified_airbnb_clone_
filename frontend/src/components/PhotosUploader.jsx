...
const PhotosUploader = ({
  ...
  const removePhoto = (filename) => {
    setInput((state) => ({
      ...state,
      addedPhotos: state.addedPhotos.filter((photos) => photos !== filename),
    }));
  };

  const selectAsThumbnail = (filename) => {
    const notThumbnail = addedPhotos.filter((photo) => photo !== filename);
    const updated = [filename, ...notThumbnail];
    setInput((state) => ({ ...state, addedPhotos: [...updated] }));
  };
